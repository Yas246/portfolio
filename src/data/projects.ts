...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Génération d'Insights pertinents grâce aux LLM",
    ],
    techStack: ["Python", "Streamlit", "Pandas", "Plotly", "Gemini"],
  },
  {
    id: "chronosesh",
    name: "ChronoSesh",
    ...
    language: "Python",
    topics: ["Notes", "Education", "Audio", "AI", "Streamlit"],
    stars: 0,
    images: ["/images/sesh.png"],
    features: [
      "Enregistrement audio en temps réel avec capture API MediaRecorder",
      "Transcription automatique avec faster-whisper (ASR optimisé)",
      "Débruitage audio avec Facebook Denoiser (modèle DNS64)",
      "Résumés automatiques multi-niveaux avec LLM",
      "Extraction de concepts clés et génération de questions de révision",
      "Gestion des sessions de cours avec base de données SQLite",
      "Export multi-formats (Markdown, PDF)",
      "Interface Streamlit avec visualisation en temps réel",
      "Recherche avancée dans les notes avec Whoosh",
    ],
    techStack: [
      "Python",
      "faster-whisper",
